...
CASES: list[RegressionCase] = [
    ...
    RegressionCase(
        ...
        text="Сертификат качества Harbor DDOS Protection.",
        expect_rules={"RuStyleGuide.ProductNames"},
    ),
    RegressionCase(
        name="product name: missing space in Harbor Shield is reported",
        text="Личный кабинет HarborShield Protection.",
        expect_rules={"RuStyleGuide.ProductNames"},
    ),
    RegressionCase(
