...
[**Развертывание**](deploy.md), здесь собраны детали и подводные камни.
...
- Используется образ `erikvl87/languagetool`, закрепленный по digest.
  ...
  последствия разобраны на странице [**Жесткая настройка для публичного хоста**](hardening.md).
...
(см. страницу [**TLS и обратный прокси**](tls-proxy.md)) или остается незакрытым (см. страницу
[**Жесткая настройка для публичного хоста**](hardening.md)).
