...
подробности в [**Implementation Guide**](../ops/deploy.md) на странице [**Переменные окружения**](../ops/config-env.md).
...
том же pull request (правило закреплено на странице [**Поддержка документации**](docs-site.md)).
