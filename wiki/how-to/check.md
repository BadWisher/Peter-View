...
Экран ставит задачу `POST /api/jobs` и ждёт SSE. Обход сайта на много страниц (`/api/check-url`, до 200 адресов) этим разделом не вызывается: вкладка «Ссылка» загружает одну страницу.
