...
Резервное копирование и восстановление описаны в **Implementation Guide** на
странице **Резервное копирование и восстановление**.
...
├── stats.db                    токены, срабатывания правил, история, кэш модели
├── watch.db                    мониторинг (+ watch.db.key ключ маскирования)
...
копирования и проверки восстановления описан в **Implementation Guide** на
странице **Резервное копирование и восстановление**.
